...
public:
	 ...
	 *    This is currently only supported by the OpenEXR format loader.
	 */
	Bitmap(fs::pathref path, const std::string &prefix = "");
	 ...
	 *    5 for PNG and 100 for JPEG files.
	 */
	void write(EFileFormat format, fs::pathref filename, int compression = -1) const;
	 ...
	 *    5 for PNG and 100 for JPEG files.
	 */
	void write(fs::pathref filename, int compression = -1) const;
