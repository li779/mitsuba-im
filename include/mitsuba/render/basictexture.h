...
#pragma once
#if !defined(__MITSUBA_RENDER_BASICTEXTURE_H_)
#define __MITSUBA_RENDER_BASICTEXTURE_H_
...
public:
	...
	MTS_EXPORT_RENDER ConstantSpectrumTexture(Stream *stream, InstanceManager *manager);
...
#ifdef MTS_HAS_HW
	MTS_EXPORT_HW Shader *createShader(Renderer *renderer) const;
#endif

	MTS_EXPORT_RENDER ref<Bitmap> getBitmap(const Vector2i &resolutionHint) const;

	MTS_EXPORT_RENDER void serialize(Stream *stream, InstanceManager *manager) const;
...
public:
	...
	MTS_EXPORT_RENDER ConstantFloatTexture(Stream *stream, InstanceManager *manager);
...
public:
	...
	MTS_EXPORT_RENDER SpectrumAdditionTexture(Stream *stream, InstanceManager *manager);
...
public:
	...
	MTS_EXPORT_RENDER SpectrumSubtractionTexture(Stream *stream, InstanceManager *manager);
...
public:
	...
	MTS_EXPORT_RENDER SpectrumProductTexture(Stream *stream, InstanceManager *manager);
