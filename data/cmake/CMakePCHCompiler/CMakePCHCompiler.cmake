...
function(target_precompiled_header) # target [...] header
	...
	foreach(target ${ARGS_UNPARSED_ARGUMENTS})
		...
		if(NOT ARGS_REUSE)
			...
			#message("Language " ${pch_target} ": " ${lang}PCH)
			if(MSVC)
		...
		if(CMAKE_VERSION VERSION_LESS 3.3)
			...
			set(flags "$<$<COMPILE_LANGUAGE:${lang}>:${flags}>")
		endif()
...
function(__watch_pch_last_hook variable access value)
	...
	foreach(index RANGE -${length} -1)
		...
		foreach(property
			...
			get_property(value_dir DIRECTORY PROPERTY ${property})
			get_target_property(value ${target} ${property})
			if(value AND NOT "${value}" STREQUAL "${value_dir}")
				...
				if(property STREQUAL "COMPILE_OPTIONS")
					...
					if(NOT value)
						set(value "PCH_EXCLUDED")
					endif()
				endif()
				if(NOT value STREQUAL "PCH_EXCLUDED")
					#if(property STREQUAL "INCLUDE_DIRECTORIES")
					#	message(${target} ${property}: "${value}")
					#	message(dir ${property}: "${value_dir}")
					#endif()
...
function(__compute_pch_build_path build_path path)
	...
	else() # if(source_dir_pos EQUAL 0)
