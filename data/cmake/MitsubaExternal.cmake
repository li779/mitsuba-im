...
if((MSVC OR APPLE) AND NOT MTS_NO_DEPENDENCIES AND
  ...
  if (MSVC)
    set(Qt5_DIR              "${CMAKE_CURRENT_LIST_DIR}/../windows/Qt/Qt5")
    set(_qt5_root_dir        "${MTS_DEPS_DIR}")

    install(DIRECTORY ${MTS_DEPS_DIR}/lib/ DESTINATION ${PROJECT_BINARY_DIR}/binaries/$<CONFIG>/${MTS_LIB_DEST} FILES_MATCHING PATTERN "*.dll")
    install(DIRECTORY ${MTS_DEPS_DIR}/lib/ DESTINATION ${MTS_EXE_DEST} FILES_MATCHING PATTERN "*.dll")
  elseif(APPLE)
...
if (Qt5Widgets_FOUND AND Qt5XmlPatterns_FOUND)
  ...
  if(POLICY CMP0020) # Automatically link qtmain
