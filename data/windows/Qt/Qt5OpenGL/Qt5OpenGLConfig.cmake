...
set(_qt5OpenGL_install_prefix ${_qt5_root_dir})

# For backwards compatibility only. Use Qt5OpenGL_VERSION instead.
set(Qt5OpenGL_VERSION_STRING 5.9.1)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.9.1"
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.9.1/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.1 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELWITHDEBINFO "Qt5OpenGL.dll" "Qt5OpenGL.lib" )
